...
@onready var leftpole = $board/lthightarget
@onready var rightpole = $board/rthightarget
@onready var leftfoot = $board/leftIKtarget
@onready var rightfoot = $board/rightIKtarget
@onready var board = $board
@onready var armature = $Armature
@onready var armrotator = $board/armrotator/rightarmlookat
@onready var camera = $playercam
@onready var aimcast = $playercam/RayCast3D
